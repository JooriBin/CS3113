...
void Menu::initialise()
{
    ...
    m_game_state.player->set_scale(glm::vec3(0, 0, 0));
...
{
    Utility::draw_text(g_shader_program, g_font_texture_id, "FOXY WORLD!", 0.5f, 0.05f,
        glm::vec3(2.5f, -2.0f, 0.0f));
    Utility::draw_text(g_shader_program, g_font_texture_id, "Press ENTER to start", 0.35f, 0.00001f,
